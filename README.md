...
| [Text Transformer](./projects/packages/text-transformer/README.md)           | Transform your text with Alfred—translate, check spelling, correct grammar, explain, extract action items, and much more! | [v5.4.1](https://github.com/avivbens/alfredo/releases/tag/release/text-transformer/5.4.1)      | [Download Workflow](https://github.com/avivbens/alfredo/releases/download/release/text-transformer/5.4.1/text-transformer_5.4.1.alfredworkflow)           | [![Total Downloads](https://img.shields.io/github/downloads/avivbens/alfredo/release%2Ftext-transformer%2F5.4.1/total?label=Version%20Downloads&color=blue)](https://github.com/avivbens/alfredo/releases)      |
